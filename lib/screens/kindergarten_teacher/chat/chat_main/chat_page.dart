...
class _ChatPageState extends State<ChatPage> {
  ...
  _checkUserOnline() {
    try {
      ...
      print('Error in _checkUserOnline: $e');
    }
  }
  ...
  void initState() {
    super.initState();
    try {
      Get.put(ChatMessageProvider()).currentChatReciver =
          widget.userInfo['_id'];
      ...
      print('Error in initState: $e'); // Debugging print statement
    }
  }
