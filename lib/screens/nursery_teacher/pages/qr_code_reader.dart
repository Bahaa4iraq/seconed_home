  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) {
      ...
      AttendAPI().addAttend(scanData.code).then((res){
        Get.back();
        if(res['error']){
          Get.snackbar(res['title'], res['message'],colorText: MyColor.white0,backgroundColor: Colors.deepOrange);
        }else{
          Get.snackbar(res['title'], res['message'],colorText: MyColor.white0,backgroundColor: MyColor.green);
        }
        EasyLoading.dismiss();
      });
    });
