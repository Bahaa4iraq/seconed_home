...
class _ChatPageState extends State<ChatPage> {
  ...
  _getChatOfStudent() {
    ...
    ChatStudentListAPI().getChatOfStudent(_data).then((res) {
      EasyLoading.dismiss();
      if (!res['error']) {
  ...
  void initState() {
    ...
    Get.put(ChatSocketProvider()).socket.emit('readMessage', widget.userInfo['_id']);
    super.initState();
  }
  ...
  _sendTextMessage() {
    ...
    Get.put(ChatSocketProvider()).socket.emit('message', _data);
