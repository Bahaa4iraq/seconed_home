...
class _MessagesState extends State<Messages> {
  ...
  void initState() {
    initFunction(
        _mainDataProvider.mainData['account']['account_division_current']['_id']
            .toString(),
        _mainDataProvider.mainData['setting_year'].toString(),
        type,
        page);
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        page++;
        initFunction(
            _mainDataProvider.mainData['divisions'][0]['class_school_id']
                .toString(),
            _mainDataProvider.mainData['setting_year'].toString(),
            type,
            page);
                          ...
                          child: ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Text(toDateAndTime(
                                    val.data[indexes]['created_at'], 24)),
