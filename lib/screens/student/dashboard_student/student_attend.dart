...
import 'package:secondhome2/static_files/my_loading.dart';
...
class _StudentAttendState extends State<StudentAttend> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: myAppBar("الحضور",MyColor.turquoise),
      body: Column(
    ...
    child: ListTile(
      title: Text(
        ...
        style: const TextStyle(
            color: MyColor.turquoise, fontWeight: FontWeight.bold),
      ),
...
Widget _text(String _text) {
  if (_text == "vacation") {
    return const Text(
      "اجازة",
      style: TextStyle(color: MyColor.turquoise, fontWeight: FontWeight.bold),
    );
      ...
      children: [
        ...
        Container(
          ...
          decoration: const BoxDecoration(
              color: MyColor.turquoise, shape: BoxShape.circle),
          child: Text(
            _count.toString(),
