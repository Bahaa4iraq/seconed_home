...
class _FoodState extends State<Food> {
  ...
  _getData() {
    ...
    NotificationsAPI().getNotificationsFood(_data);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: myAppBar("غذاء",MyColor.pink),
      body: GetBuilder<FoodNotificationProvider>(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Get.to(() => ShowMessage(
                          ...
                          onUpdate: (){
                            NotificationsAPI().updateReadFood(val.data[indexes]['_id']);
                          },
                        ),
                        );
                      },
