...
class _ClothesState extends State<Clothes> {
  ...
  _getData() {
    ...
    NotificationsAPI().getNotificationsClothes(_data);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: myAppBar("ملابس",MyColor.pink),
      body: GetBuilder<ClothesNotificationProvider>(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Get.to(() => ShowMessage(
                          ...
                          onUpdate: (){
                            NotificationsAPI().updateReadClothes(val.data[indexes]['_id']);
                          },
                        ),
                        );
                      },
