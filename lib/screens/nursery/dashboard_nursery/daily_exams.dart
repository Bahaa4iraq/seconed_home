...
class _DailyExamsState extends State<DailyExams> {
  ...
  _getData() {
    ...
    String classId = _mainDataGetProvider.mainData['account']['account_division_current']['_id'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: myAppBar("الامتحانات اليومية",MyColor.pink),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _data['daily_exam_degrees'].isEmpty ? const Text("--") : Text(_data['daily_exam_degrees']['degree'].toString()),
            ],
          ),
          Row(
            children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
                toDateAndTime(_data['created_at'],12),
                style: TextStyle(color: MyColor.grayDark.withOpacity(0.3)),
              ),
            ],
          ),
...
dialog(String daily_exam_note) {
  return Get.defaultDialog(title: "المادة الامتحانية", content: Text(daily_exam_note));
}
