...
import 'package:secondhome2/screens/kindergarten_teacher/live_education/live_education.dart';
...
class Attende extends StatefulWidget {
  const Attende({super.key, required this.color});
  final Color color;
...
class _AttendeState extends State<Attende> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: myAppBar("دخول وخروج", widget.color),
