...
import '../screens/nursery/dashboard_nursery/messages.dart'  as nursery;
...
import '../screens/nursery/dashboard_nursery/nursery_salary/nursery_salary.dart' as nursery;
...
import '../screens/student/dashboard_student/student_salary/student_salary.dart' as student;
import '../screens/student/dashboard_student/weekly_schedule.dart' as student;
import '../screens/kindergarten_teacher/pages/notifications/notification_all.dart' as teacherKindergartion;
import '../screens/kindergarten_teacher/pages/teacher_salary/teacher_salary.dart' as teacherKindergartion;
import '../screens/nursery_teacher/pages/teacher_salary/teacher_salary.dart' as teacherNursery;
import '../screens/nursery_teacher/pages/notifications/notification_all.dart' as teacherNursery;
import '../screens/kindergarten_teacher/pages/teacher_weekly_schedule.dart'  as teacherKindergartion;
import '../screens/nursery_teacher/pages/teacher_weekly_schedule.dart'  as teacherNursery;
...
receivedMessages(RemoteMessage message) {
  ...
  if (_userData != null) {
    Get.put(TokenProvider()).addToken(_userData);
  }
  ...
  else if (_userData["account_type"] == "student") {
    if (message.data['type'] == 'news') {
      DashboardDataAPI().latestNews(); //update news
    }
    if (_userData["is_kindergarten"]) {
      _redirectToStudentScreens(message, _userData);
    }
    else{
      _redirectToNurseryScreens(message, _userData);
    }

  } else if (_userData["account_type"] == "driver") {
  } else if (_userData["account_type"] == "teacher") {
    if (_userData["is_kindergarten"]) {
      ...
      if (message.data['type'] == 'schedule') {
        ...
        Get.to(() => teacherNursery.NotificationTeacherAll(userData: _userData));
      } else if (message.data['type'] == 'installments') {
...
_redirectToNurseryScreens(RemoteMessage message,Map<dynamic, dynamic> userData){
  if (message.data['type'] == 'schedule') {
